...
public class ProgramaPrincipal {
	...
	JOptionPane.showMessageDialog(null, "Média do Aluno " 
                + aluno1 + " = " + 	df.format(aluno1.calculaMedia()) +
                "\nSituação curricular: " + aluno1.situacaoCurricular());
	
        JOptionPane.showMessageDialog(null, "Média do Aluno " 
                + aluno2 + " = " + 	df.format(aluno2.calculaMedia()) +
                "\nSituação curricular: " + aluno2.situacaoCurricular());
	
        JOptionPane.showMessageDialog(null, "Média do Aluno " 
                + aluno3 + " = " + 	df.format(aluno3.calculaMedia()) +
                "\nSituação curricular: " + aluno3.situacaoCurricular());
	
        JOptionPane.showMessageDialog(null, "Média do Aluno " 
                + aluno4 + " = " + 	df.format(aluno4.calculaMedia()) +
                "\nSituação curricular: " + aluno4.situacaoCurricular());
