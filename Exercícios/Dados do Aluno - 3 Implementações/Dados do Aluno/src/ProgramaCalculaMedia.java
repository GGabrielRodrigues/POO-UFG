...
public class ProgramaCalculaMedia {
	...
	JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) "
                + nomeAluno1 + " (Matrícula - " + matAluno1 + ") = " 
                + df.format(mediaAluno1) + " - " + apAluno1);
        
	JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " 
                + nomeAluno2 + " (Matrícula - " + matAluno2 + ") = " 
                + df.format(mediaAluno2) + " - " + apAluno2);
        
	JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " 
                + nomeAluno3 + " (Matrícula - " + matAluno3 + ") = " 
                + df.format(mediaAluno3) + " - " + apAluno3);
        
	JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " 
                + nomeAluno4 + " (Matrícula - " + matAluno4 + ") = " 
                + df.format(mediaAluno4) + " - " + apAluno4);
        
			
	JOptionPane.showMessageDialog(null,"Média Geral = " 
                + df.format(mediaGeral));
		}
}
