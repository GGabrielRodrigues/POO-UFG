...
public class TestaClasse {
    public static void main(String[] args) {
        //Criação dos objetos
        Produtos produtoUm = new Produtos(); //Obj com o primeiro construtor
        Produtos produtoDois = new Produtos("Tomate"); //Obj com o segundo construtor
        Produtos produtoTres = new Produtos("Jilo", 5); //Obj com o terceiro construtor
        Produtos produtoQuatro = new Produtos("Jurubeba", 12, "Alimento", 13.98); //Obj com o quarto construtor
        //
